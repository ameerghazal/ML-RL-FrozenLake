...
def SARSA(episodes, decayParam = (1, 0.0001, "linear"), render=False):
...
if __name__ == '__main__':
    ...
    avgTotalReward_linear = SARSA(20000, decayParam=(1, 0.0001, "linear"))
    avgTotalReward_exponential = SARSA(20000, decayParam=(1, 0.0001, "exponential"))
    avgTotalReward_inverse = SARSA(20000, decayParam=(1, 0.0001, "inverse"))
